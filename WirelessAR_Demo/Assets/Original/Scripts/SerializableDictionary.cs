...
namespace Serialize {
    ...
    /// </summary>
    [System.Serializable]
    public class ColorTable : Serialize.TableBase<Color, bool, ColorPair>{ }

    /// <summary>
    /// カラーペア
    /// </summary>
    [System.Serializable]
    public class ColorPair : Serialize.KeyAndValue<Color, bool>{
        public ColorPair (Color key, bool value) : base (key, value) { }
    }
}